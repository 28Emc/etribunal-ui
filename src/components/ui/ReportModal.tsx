...
export const ReportModal: React.FC<ReportModalProps> = ({ caseTitle, onClose, onSubmit }) => {
      ...
      >
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h4 className="text-xl font-black italic uppercase tracking-tighter text-text-main">{t('moderator.reportCase')}</h4>
        ...
        <div className="space-y-3">
          <label className="text-xs font-black uppercase tracking-widest text-text-muted">
            {t('moderator.reportReason')}
          </label>
          <textarea
            value={reason}
            onChange={(e) => setReason(e.target.value)}
            placeholder={t('moderator.reportReasonPlaceholder')}
